...
local repositoryURL = "https://raw.githubusercontent.com/Programivan/MineOS/master/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "MacOS")
...
local installerMenu = menu:addContextMenuItem("MacOS", 0x2D2D2D)
